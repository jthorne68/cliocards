...
var ASM_CONSTS = {
  5221096: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 5221151: ($0) => { performance.now = function() { return $0; }; },  
 5221199: ($0) => { performance.now = function() { return $0; }; },  
 5221247: () => { performance.now = Module['emscripten_get_now_backup']; }
};
